...
## 🧭 About Me  
- 🧠 Currently learning **Java (Spring Boot, MySQL, REST APIs)**  
- 🔐 Exploring **Cybersecurity** with **TryHackMe**  
- 💼 Training at **Ducat Noida (Sector 62)**  
- 🧰 Love working on **real-world projects** & documenting them on GitHub  
- 🎯 Goal: Become a **Backend & Security-Aware Developer**

---

## 🧩 Featured Learning Journey  

### 🧠 TryHackMe — Cybersecurity Roadmap  
📘 My notes, badges, and progress from TryHackMe modules:  
- [Offensive Security Intro (Completed ✅)](https://tryhackme.com/room/offensivesecurityintro)  
- Defensive Security Intro 🚀 *(coming soon)*  

---

## 💻 Java Backend Progress  
- Completed basics of **Java Syntax, Loops, and If-Else**  
- Solving **HackerRank Java Challenges** daily  
- Preparing for **Spring Boot Projects** (ExpenseIQ + Mini APIs)  
...
- 🌐 Building public GitHub documentation for my progress  
...
⭐ *“Learning in public is the best way to grow as a developer.”*  
